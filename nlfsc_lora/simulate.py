...
from .receiver import fft_correlation_demod, fft_demod, matched_filter_bank_demod
...
_DEMODS = {
    "fft": fft_demod,
    "mfbank": matched_filter_bank_demod,
    "fft_corr": fft_correlation_demod,
    "cfo_search": joint_cfo_symbol_demod,
}
